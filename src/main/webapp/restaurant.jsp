                                        ...
                                        <div class="card-body ps-0">
                                            <div class="d-flex align-items-center mb-3">
                                                <div class="flex-1 ms-3">
                                                    <h5 class="mb-1 fw-bold text-1000">
                                                        ...
                                                        <i class="fa-solid fa-star-half-stroke"></i></span><span
                                                        class="text-1000">
                                                        <%= restaurant.getRating() %>
                                                    </span>
                                                    <span class="fw-bold text-1000"><i class="fa fa-clock-o"></i> • <%= restaurant.getDeliveryTime() %>mins</span>
                                                    <div><span class="text-1000"><i class="fa fa-cutlery"></i>
                                                            <%= restaurant.getCuisineType() %>
                                                        </span></div>
                                                    <span class="text-1000"><i class=" fa-solid fa-location-dot"></i>
                                            ...
                                            <% if (restaurant.isActive()==true) { %>
                                                ...
                                                <a href="<%= request.getContextPath() %>/menu?restaurantID=<%= restaurant.getRestaurantId() %>"
                                                    class="badge bg-soft-danger p-2"><span
                                                        class="fw-bold fs-1 text-success">Open Now</span></a>
